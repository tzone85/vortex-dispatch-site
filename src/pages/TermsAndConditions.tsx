    ...
    <>
      ...
      <main className="min-h-screen bg-void text-bone">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold mb-8 text-accent">Terms and Conditions</h1>
          <div className="space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">2. Use License</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">3. Disclaimer</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">4. Limitations</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">5. Accuracy of Materials</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">6. Links</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">7. Modifications</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">9. Contact Information</h2>
              <p>
