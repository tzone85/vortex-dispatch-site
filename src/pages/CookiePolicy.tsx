      ...
      <main className="min-h-screen bg-void text-bone">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">2. Types of Cookies We Use</h2>
              <p>Our website uses the following types of cookies:</p>

              <h3 className="text-xl font-semibold mt-4 mb-2 text-accent">Essential Cookies</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mt-4 mb-2 text-accent">Analytics Cookies</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mt-4 mb-2 text-accent">Preference Cookies</h3>
              <p>
                These cookies remember your preferences and choices to personalize your experience when you visit our website again.
              </p>

              <h3 className="text-xl font-semibold mt-4 mb-2 text-accent">Marketing Cookies</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">3. How to Control Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">4. Third-Party Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-accent">6. Changes to This Cookie Policy</h2>
              <p>
