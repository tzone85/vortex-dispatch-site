...
export const faq: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Email hello@vortexdispatch.co.za with a paragraph on the problem you want solved. You get a reply within one business day, a short discovery call, and then a scoped fixed-price proposal, with no obligation before that point.",
  },
] as const;
